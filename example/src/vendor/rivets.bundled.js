...
(function() {
  ...
  Rivets.ComponentBinding = (function(_super) {
    ...
    ComponentBinding.prototype.parseAttributes = function() {
      var attribute, bindingRegExp, propertyName, _i, _len, _ref1, _ref2, _results;
    ...
    ComponentBinding.prototype.bind = function() {
      ...
      if (this.componentView != null) {
        ...
        scope = this.component.initialize.call(this, this.el, this.locals(), this.deps());
        if (this.component.template) {
          this.renderTemplate(scope);
        }
        if (this.component.bind)
          this.component.bind.call(this, this.el);
        Rivets.Util.domData(this.el, 'isBound', true);
        Rivets.Util.domData(this.el, "" + this.type + "Component", scope);
        options = {};
        ...
        var viewScope = Object.create(this.view.models);
        viewScope[this.component.as || this.camelCase(this.type)] = scope;
        viewScope.component = this;
        this.componentView = new Rivets.View(this.el, viewScope, options);
    ...
    ComponentBinding.prototype.renderTemplate = function(scope) {
      var template;
      if (typeof this.component.template === "function") {
        template = this.component.template.call(this, scope);
      } else {
